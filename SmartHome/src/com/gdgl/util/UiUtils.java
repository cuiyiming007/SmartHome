...
public class UiUtils {
    ...
    public static int[] DEVICES_MANAGER_IMAGES = { R.drawable.img0001,R.drawable.img0030,R.drawable.img0100,R.drawable.img0200,R.drawable.img0330 };
    public static String[] DEVICES_MANAGER_TAGS = {"照明管理","电器控制","安全防护","环境监测","节能"};
