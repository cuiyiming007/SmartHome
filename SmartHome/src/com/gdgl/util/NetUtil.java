...
"data":{
   "morepage":
    [
         {"id":-1,"count":18209,"onRed":false,"iconUrl":"http://ms0.meituan.net/group/deal/cate/android/4.0/-1-small.png","name":"全部分类"},
         {"id":1,"count":8466,"onRed":false,"iconUrl":"http://ms0.meituan.net/group/deal/cate/android/4.0/1-small.png","name":"美食",
             "list":[
                  {"id":1,"onRed":false,"name":"全部"},
	 * 
	 * @param s
	 */
