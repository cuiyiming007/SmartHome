...
//			}
	...
	public void recieveFromUdp() {
		...
		DatagramPacket recievepaPacket = new DatagramPacket(recieveData,
				recieveData.length);
		try {
		...
		String result = new String(recievepaPacket.getData(),
				recievepaPacket.getOffset(), recievepaPacket.getLength());
