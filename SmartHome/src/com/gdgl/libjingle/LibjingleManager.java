...
public class LibjingleManager extends Manger {
	...
	private static LibjingleManager instance;

	public static LibjingleManager getInstance() {
		if (instance == null) {
			instance = new LibjingleManager();
		}
		return instance;
	}
...
//		};
	...
	public void addBindData(String bindtype,String devout_ieee,String devout_ep,
		...
		String url = LibjingleNetUtil.getInstance().getLocalhostURL("AddBindData.cgi", param);
		Log.i("CGIManager bindDevice Request:%n %s", url);
		
//		LibjinglePackHandler.packUrl(reqId, jid, url)
