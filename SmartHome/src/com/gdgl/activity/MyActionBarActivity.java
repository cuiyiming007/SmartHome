			...
			if (event.isSuccess() == true) {
				...
				if(status == 1) {
					tipsWithoutNet.post(new Runnable() {
						...
						public void run() {
							// TODO Auto-generated method stub
							MyOKOnlyDlg myOKOnlyDlg = new MyOKOnlyDlg(MyActionBarActivity.this);
							myOKOnlyDlg.setContent("别名、密码已初始化，请重新登录！");
							myOKOnlyDlg.setCannotCanceled();
							myOKOnlyDlg.setDialogCallback(MyActionBarActivity.this);
							myOKOnlyDlg.show();
						}
					});
				} else if(status == 2) {
			...
			if (event.isSuccess() == true) {
				...
				if(number == 1) {
					...
					tipsWithoutNet.post(new Runnable() {
						...
						public void run() {
							// TODO Auto-generated method stub
							MyOKOnlyDlg myOKOnlyDlg1 = new MyOKOnlyDlg(MyActionBarActivity.this);
					...
					tipsWithoutNet.post(new Runnable() {
						...
						public void run() {
							// TODO Auto-generated method stub
							MyOKOnlyDlg myOKOnlyDlg2 = new MyOKOnlyDlg(MyActionBarActivity.this);
							myOKOnlyDlg2.setContent("网关未授权，不能正常使用！");
							myOKOnlyDlg2.setCannotCanceled();
							myOKOnlyDlg2.setDialogCallback(MyActionBarActivity.this);
