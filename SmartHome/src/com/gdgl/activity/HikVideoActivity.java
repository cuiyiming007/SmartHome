 ...
 * @modificationHistory
 */
public class HikVideoActivity extends Activity implements Callback {
...
//		mActionBar.setTitle(m_titleName);
	...
	private void setListeners() {
		...
		goback.setOnClickListener(goback_Listener);
	}
	
	private OnClickListener goback_Listener = new OnClickListener() {
