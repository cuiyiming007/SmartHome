...
public class DecodeH264 extends View implements Runnable
{
	...
	//Bitmap VideoBit = Bitmap.createBitmap(h264Width, h264Height, Config.RGB_565);
	Bitmap VideoBit = Bitmap.createBitmap(h264Width, h264Height, Config.RGB_565);
	...
	public DecodeH264(Context context, int deviceWidth, int deviceheight) 
	{
		super(context);
			...
			try
			{
			    ...
			    if(str1.equals("startvideo"))
			    {
			    	...
			    	try
				    {
				    	//��ȡ��ݶ���  
				    	JSONObject user = 
				    			responseCommand.getJSONObject("response_params");
	...
	public void run() 
	{
		...
		while (!Thread.currentThread().isInterrupted())
		{
			...
			{
				nalLen = MergeBuffer(decoderInBuf, NalBufUsed, 
									buffFromSocket,SockBufUsed, 
									bytesReadFromSocketNum - SockBufUsed);
